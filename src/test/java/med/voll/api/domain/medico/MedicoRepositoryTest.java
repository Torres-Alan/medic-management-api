...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deberia devolver null cuando el médico buscado existe pero no esta disponible en esa fecha")
    ...
    @Test
    @DisplayName("Deberia devolver médico cuando el médico buscado esta disponible en esa fecha")
